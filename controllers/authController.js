...
exports.resetPassword =  catchAsyncErrors(async (req, res,next) => {
    ...
    if(!user){
        return next(new ErrorHandler('Password reset token is invalid or exp',400))
    }
...
exports.getUserAll = catchAsyncErrors(async (req, res,next) => {
